...
public interface InspectionCaseDao {
	...
	@Select("SELECT inspection_case_id as inspectionCaseId, result, fee, item_name as itemName, department_name as departmentName, inspection_item.intro as intro " +
	...
	@Select("SELECT url FROM inspection_case JOIN inspection_graph " +
