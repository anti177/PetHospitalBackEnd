...
public interface ActorDao {
	...
	@Select("SELECT process.process_id as id,intro,process_name as name, operation.sort_num as sortNum, operation.operation_name as operationName, operation.url as url " +
