...
public interface TestDao extends Mapper<Test> {
  ...
  @Select(
      "SELECT test.test_id as test_id, begin_date as beginDate, end_date as endDate, test_name as testName "
  ...
  @Select(
      "SELECT test.test_id as testId, begin_date as beginDate, end_date as endDate, score, test_name as testName, has_submit as hasSubmit  "
