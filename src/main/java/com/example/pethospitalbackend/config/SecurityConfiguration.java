...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
  ...
  @Autowired private SecurityProblemSupport securityProblemSupport;
  ...
  public void configure(WebSecurity web) {
    web.ignoring().antMatchers(HttpMethod.OPTIONS, "/**").antMatchers("/test/**");
  }
  ...
  protected void configure(HttpSecurity http) throws Exception {
    http.addFilterBefore(corsFilter, UsernamePasswordAuthenticationFilter.class)
        ...
        .permitAll()
        // 配置登录地址
        .antMatchers(HttpMethod.PATCH, SecurityConstants.AUTH_LOGIN_URL)
        .permitAll()
        // 配置注册地址
        .antMatchers(HttpMethod.POST, SecurityConstants.AUTH_REGISTER_URL)
        .permitAll()
        .antMatchers(HttpMethod.POST, SecurityConstants.SEND_CODE)
        .permitAll()
        .antMatchers(HttpMethod.PATCH, SecurityConstants.FORGET_PASSWORD)
        .permitAll()
