package com.example.pethospitalbackend.filter;
 ...
 *
 * <p>提供请求授权功能。用于处理所有 HTTP 请求，并检查是否存在带有正确 token 的 Authorization 标头。 如果 token 有效，则过滤器会将身份验证数据添加到
 * Spring 的安全上下文中，并授权此次请求访问资源。
 *
 * @author yyx
 */
public class JwtAuthorizationFilter extends BasicAuthenticationFilter {
  ...
  protected void doFilterInternal(
    ...
    // 从 HTTP 请求中获取 token，这里会去掉前缀"bearer"
